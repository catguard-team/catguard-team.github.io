...
이 레포는 GitHub Pages로 자동 배포됩니다 (main 브랜치 → 루트). 자경단 본문이나 운영 문서는 [`catguard-team/.github`](https://github.com/catguard-team/.github)에 있습니다.
...
아래 키워드로 검색하셔도 이 저장소와 페이지를 찾으실 수 있도록 문구를 유지합니다.
